...
in_out double "P_Default1");
   ...
   if null(pm) then do;
      pm = _new_ pymas();
      resultCode = pm.useModule('model_exec_a8c086ba-9f43-4064-b93b-c4472d449ac9', 1);
      if resultCode then do;
         ...
         resultCode = pm.appendSrcLine('import _dj5n7wg1ne74bjo4ln9lur5fz_ccef4d59_2ff3_4b5b_a3cd_46e89ab76806');
         ...
         resultCode = pm.appendSrcLine('    return _dj5n7wg1ne74bjo4ln9lur5fz_ccef4d59_2ff3_4b5b_a3cd_46e89ab76806.score_method(Delinquencies, DerogatoryMarks, Inquiries, JobType, CredLineAge, CredLines, DebtIncRatio, LoanRequest, HomeValue, Income, LoanToValue, YearsOnJob)');

         revision = pm.publish(pm.getSource(), 'model_exec_a8c086ba-9f43-4064-b93b-c4472d449ac9');
