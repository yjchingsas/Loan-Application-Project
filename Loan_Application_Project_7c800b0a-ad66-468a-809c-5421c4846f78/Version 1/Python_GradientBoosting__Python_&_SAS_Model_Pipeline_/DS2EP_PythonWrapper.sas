data sasep.out;
   ...
   in_out varchar(100) "I_Default");
      ...
      if null(pm) then do;
         pm = _new_ pymas();
         resultCode = pm.useModule('model_exec_c06b76e3-c844-4fed-b55e-0c6fc4d28e30', 1);
         if resultCode then do;
            ...
            revision = pm.publish(pm.getSource(), 'model_exec_c06b76e3-c844-4fed-b55e-0c6fc4d28e30');
