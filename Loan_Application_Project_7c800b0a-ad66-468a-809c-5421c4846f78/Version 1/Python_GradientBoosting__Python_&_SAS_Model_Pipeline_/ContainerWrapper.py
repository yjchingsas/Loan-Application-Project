...
for i, row in input_df.iterrows():
    rowResult.append(_dj5n7wg1ne74bjo4ln9lur5fz.score_method(row['Delinquencies'],row['DerogatoryMarks'],row['Inquiries'],row['JobType'],row['CredLineAge'],row['CredLines'],row['DebtIncRatio'],row['LoanRequest'],row['HomeValue'],row['Income'],row['LoanToValue'],row['YearsOnJob']))
